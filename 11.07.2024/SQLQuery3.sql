...
alter proc HavaleÝslemi @CustomerNo nvarchar(10),@Password nvarchar(4),@AccountNo int,@Price float,@ReceiverAccountNo nvarchar(10)
as
begin
    declare @IsCustomer int
	declare @IsReceiverAccountNo int
    declare @IsPassword nvarchar(4)
    declare @ErrorPasswordCount int
    declare @IsBlock bit
	declare @IsReceivedBlock bit
    ...
    begin
        ...
        begin
			...
			update Account set Balance=Balance-@Price where Id=@CustomerNo


			if(@Balance>=@Price)
			begin
			     update Account set Balance=Balance+@Price where Id=@ReceiverAccountNo
...
exec HavaleÝslemi 'DB10000002','1234',3,150000,'DB10000002'


create proc HavaleÝslemi @CustomerNo nvarchar(10),@Password nvarchar(4),@AccountNo int,@Price float,@ReceiverCustomerNo nvarchar(10)
